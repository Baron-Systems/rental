<template>
  <div v-if="session.state.loading" class="flex items-center justify-center h-screen" style="background: linear-gradient(135deg, #012350);">
  ...
  <!-- No account linked -->
  <div v-else-if="session.state.account?.needs_account" class="min-h-screen flex items-center justify-center p-4" dir="rtl" style="background: linear-gradient(135deg, #012350);">
    ...
    <div class="relative w-full max-w-md text-center animate-scale-in">
      <div class="inline-flex w-16 h-16 rounded-2xl items-center justify-center mb-6 shadow-soft-lg" style="background: #b38942;">
  ...
  <!-- Account disabled -->
  <div v-else-if="session.state.account?.account_disabled" class="min-h-screen flex items-center justify-center p-4" dir="rtl" style="background: linear-gradient(135deg, #012350);">
    <div class="relative w-full max-w-md text-center animate-scale-in">
