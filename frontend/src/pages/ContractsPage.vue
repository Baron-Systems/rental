      ...
      <Card padding="md" class="mb-4">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-start">
          ...
          <div class="relative flex-1">
            <svg class="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-navy-400 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"/></svg>
            <input v-model="filters.search" type="text" placeholder="بحث برقم العقد..." class="input-premium pr-10" @input="onFilterChange" />
          </div>
          <!-- Status -->
